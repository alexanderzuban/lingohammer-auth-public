...
import com.lingohammer.aws.auth.process.register.RegistrationLambdaHandler;
...
class RegistrationLambdaHandlerTest {
    private RegistrationLambdaHandler handler;
    ...
    public void setUp() {
        ...
        handler = new RegistrationLambdaHandler().withDependencies(di);
    }
