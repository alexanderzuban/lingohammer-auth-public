...
class AuthServiceUserInfoHandlerTest {

    private AuthServiceUserInfoHandler handler;
    ...
    public void setUp() {
        ...
        handler = new AuthServiceUserInfoHandler(mockConfigurationService, mockUserService);
    }
